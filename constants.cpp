...
float ld::gameDimFullWidth = ld::gameDim;
float ld::gameDimFullHeight = ld::gameDim;
...
const unsigned int ld::fontPixmap[] = {
	...
	0x3fb8c6bf, 0x3f9ef7b9, 0x3f3bdef3, 0x3f0b4bc0, 0x3e16a5e0, 0x3fffffff, 
	0x0
};
...
#ifdef __ANDROID__
	sf::RenderTarget* ld::renderTarget = nullptr;
#endif
